...
CREATE TABLE compra (
	...
	numero_cartao NUMBER NOT NULL,
	doc_vendedor VARCHAR2(12) NOT NULL,
	data DATE NOT NULL,
	PRIMARY KEY (id_compra),
	CONSTRAINT "FK_Compra.numero_cartao" FOREIGN KEY (numero_cartao) REFERENCES Cartao(numero_cartao)
);
...
CREATE TABLE item (
	...
	PRIMARY KEY (id_item),
	CONSTRAINT "FK_item.id_compra" FOREIGN KEY (id_compra) REFERENCES Compra(id_compra)
);
